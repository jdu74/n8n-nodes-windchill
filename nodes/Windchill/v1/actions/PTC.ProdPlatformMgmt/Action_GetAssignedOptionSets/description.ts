...
export const ActionGetAssignedOptionSetsDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			{
				displayName: '* OptionSetAssignables',
				name: 'OptionSetAssignables',
				description: 'Option Set Assignables - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
