...
export const PtcProdPlatformMgmtVariantSpecificationActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /VariantSpecifications('{VariantSpecificationId}')/PTC.ProdPlatformMgmt.CheckIn",
				],
			},
		},
		required: true,
