...
export const PtcProdPlatformMgmtVariantSpecificationActionCheckOutWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /VariantSpecifications('{VariantSpecificationId}')/PTC.ProdPlatformMgmt.CheckOut",
				],
			},
		},
		required: true,
