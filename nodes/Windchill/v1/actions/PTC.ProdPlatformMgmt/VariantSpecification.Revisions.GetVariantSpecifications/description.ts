...
export const VariantSpecificationRevisionsGetVariantSpecificationsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /VariantSpecifications('{VariantSpecificationId}')/Revisions",
				],
			},
		},
		required: true,
