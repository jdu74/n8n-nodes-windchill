...
export const VariantSpecificationRevisionsGetVariantSpecificationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /VariantSpecifications('{VariantSpecificationId}')/Revisions('{RevisionsId}')",
				],
			},
		},
		required: true,
