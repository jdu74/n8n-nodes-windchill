...
export const ActionSetStateVariantSpecificationsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /SetStateVariantSpecifications',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			...
			{
				displayName: '* VariantSpecifications',
				name: 'VariantSpecifications',
				description: 'Variant Specifications - array',
				type: 'json',
