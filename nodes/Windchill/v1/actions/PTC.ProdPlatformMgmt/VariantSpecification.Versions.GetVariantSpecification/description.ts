...
export const VariantSpecificationVersionsGetVariantSpecificationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /VariantSpecifications('{VariantSpecificationId}')/Versions('{VersionsId}')",
				],
			},
		},
		required: true,
