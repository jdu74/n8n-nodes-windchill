...
export const VariantSpecificationModuleVariantInformationLinksGetModuleVariantInformationLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /VariantSpecifications('{VariantSpecificationId}')/ModuleVariantInformationLinks",
				],
			},
		},
		required: true,
