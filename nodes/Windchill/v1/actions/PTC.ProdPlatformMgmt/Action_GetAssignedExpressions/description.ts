...
export const ActionGetAssignedExpressionsDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			{
				displayName: '* ExpressionAssignables',
				name: 'ExpressionAssignables',
				description: 'Expression Assignables - array',
				type: 'json',
				default: '[\n\t{\n\t\t"CreatedOn": "string",\n\t\t"ID": "string",\n\t\t"LastModified": "string"\n\t}\n]',
			},
		],
