...
export const VariantSpecificationModuleVariantInformationLinksGetModuleVariantInformationLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /VariantSpecifications('{VariantSpecificationId}')/ModuleVariantInformationLinks('{ModuleVariantInformationLinkId}')",
				],
			},
		},
		required: true,
