...
export const PtcProdMgmtPartActionGetExtendedDatasWithInlineNavCriteriaWithDescription: INodeProperties[] = [
	{
		displayName: 'PartId',
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Parts('{PartId}')/PTC.ProdMgmt.GetExtendedDatasWithInlineNavCriteria",
				],
			},
		},
		required: true,
