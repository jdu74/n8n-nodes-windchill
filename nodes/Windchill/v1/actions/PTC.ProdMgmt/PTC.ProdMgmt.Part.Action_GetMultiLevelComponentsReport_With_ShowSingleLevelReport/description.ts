...
export const PtcProdMgmtPartActionGetMultiLevelComponentsReportWithShowSingleLevelReportDescription: INodeProperties[] = [
	{
		displayName: 'PartId',
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Parts('{PartId}')/PTC.ProdMgmt.GetMultiLevelComponentsReport",
				],
			},
		},
		required: true,
