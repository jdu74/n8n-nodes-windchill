...
export const PtcProdMgmtPartActionGetPartStructureWithPathFilterWithSiblingsDescription: INodeProperties[] = [
	{
		displayName: 'PartId',
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Parts('{PartId}')/PTC.ProdMgmt.GetPartStructure",
				],
			},
		},
		required: true,
