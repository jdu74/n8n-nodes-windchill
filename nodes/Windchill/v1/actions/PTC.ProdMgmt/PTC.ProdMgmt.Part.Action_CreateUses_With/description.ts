...
export const PtcProdMgmtPartActionCreateUsesWithDescription: INodeProperties[] = [
	{
		displayName: 'PartId',
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Parts('{PartId}')/PTC.ProdMgmt.CreateUses",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: '* PartUses',
				name: 'PartUses',
				description: 'Part Uses - array',
				type: 'json',
