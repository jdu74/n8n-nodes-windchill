...
export const ExtendedDataDepartmentDataGetDepartmentDataDescription: INodeProperties[] = [
	{
		displayName: 'PartId',
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Parts('{PartId}')/ExtendedData('{ExtendedDataId}')/DepartmentData('{DepartmentDataId}')",
				],
			},
		},
		required: true,
