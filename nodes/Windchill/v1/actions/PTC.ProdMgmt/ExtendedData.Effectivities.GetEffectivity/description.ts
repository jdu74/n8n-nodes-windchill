...
export const ExtendedDataEffectivitiesGetEffectivityDescription: INodeProperties[] = [
	{
		displayName: 'PartId',
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Parts('{PartId}')/ExtendedData('{ExtendedDataId}')/Effectivities('{EffectivityId}')",
				],
			},
		},
		required: true,
