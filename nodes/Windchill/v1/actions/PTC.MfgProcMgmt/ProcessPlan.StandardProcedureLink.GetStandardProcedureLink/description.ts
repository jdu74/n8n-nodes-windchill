...
export const ProcessPlanStandardProcedureLinkGetStandardProcedureLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessPlans('{ProcessPlanId}')/StandardProcedureLink('{StandardProcedureLinkId}')",
				],
			},
		},
		required: true,
