...
export const PtcMfgProcMgmtOperationHolderActionUpdateMpmStandardProcedureLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /OperationHolders('{OperationHolderId}')/PTC.MfgProcMgmt.UpdateMPMStandardProcedureLinks",
				],
			},
		},
		required: true,
