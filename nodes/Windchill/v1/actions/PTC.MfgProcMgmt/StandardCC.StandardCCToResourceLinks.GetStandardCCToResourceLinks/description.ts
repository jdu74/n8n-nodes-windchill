...
export const StandardCcStandardCcToResourceLinksGetStandardCcToResourceLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardCCs('{StandardCCId}')/StandardCCToResourceLinks",
				],
			},
		},
		required: true,
