...
export const OperationHolderOperationHolderUsageLinkGetOperationHolderUsageLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /OperationHolders('{OperationHolderId}')/OperationHolderUsageLink",
				],
			},
		},
		required: true,
