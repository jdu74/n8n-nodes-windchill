...
export const ProcessMaterialMpmCompatibilityLinksGetMpmCompatibilityLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessMaterials('{ProcessMaterialId}')/MPMCompatibilityLinks",
				],
			},
		},
		required: true,
