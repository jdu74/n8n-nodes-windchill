...
export const PtcMfgProcMgmtOperationHolderActionDeleteMpmDocumentDescribeLinkWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /OperationHolders('{OperationHolderId}')/PTC.MfgProcMgmt.DeleteMPMDocumentDescribeLink",
				],
			},
		},
		required: true,
