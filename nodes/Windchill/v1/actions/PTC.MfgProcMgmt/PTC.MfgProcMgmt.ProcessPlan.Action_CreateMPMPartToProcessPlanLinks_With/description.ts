...
export const PtcMfgProcMgmtProcessPlanActionCreateMpmPartToProcessPlanLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/PTC.MfgProcMgmt.CreateMPMPartToProcessPlanLinks",
				],
			},
		},
		required: true,
