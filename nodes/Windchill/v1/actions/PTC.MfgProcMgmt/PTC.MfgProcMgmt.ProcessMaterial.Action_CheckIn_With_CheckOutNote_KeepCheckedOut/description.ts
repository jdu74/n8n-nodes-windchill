...
export const PtcMfgProcMgmtProcessMaterialActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessMaterials('{ProcessMaterialId}')/PTC.MfgProcMgmt.CheckIn",
				],
			},
		},
		required: true,
