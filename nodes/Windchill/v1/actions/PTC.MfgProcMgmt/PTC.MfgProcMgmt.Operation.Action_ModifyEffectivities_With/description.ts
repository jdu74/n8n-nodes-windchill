...
export const PtcMfgProcMgmtOperationActionModifyEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.ModifyEffectivities",
				],
			},
		},
		required: true,
