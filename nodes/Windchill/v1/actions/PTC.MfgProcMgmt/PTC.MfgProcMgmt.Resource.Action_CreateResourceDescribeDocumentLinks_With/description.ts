...
export const PtcMfgProcMgmtResourceActionCreateResourceDescribeDocumentLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Resources('{ResourceId}')/PTC.MfgProcMgmt.CreateResourceDescribeDocumentLinks",
				],
			},
		},
		required: true,
