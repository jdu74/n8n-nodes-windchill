...
export const ProcessPlanDocumentReferenceLinksGetDocumentReferenceLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessPlans('{ProcessPlanId}')/DocumentReferenceLinks",
				],
			},
		},
		required: true,
