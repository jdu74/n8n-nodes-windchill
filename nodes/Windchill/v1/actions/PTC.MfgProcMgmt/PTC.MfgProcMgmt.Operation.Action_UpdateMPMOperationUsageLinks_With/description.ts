...
export const PtcMfgProcMgmtOperationActionUpdateMpmOperationUsageLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.UpdateMPMOperationUsageLinks",
				],
			},
		},
		required: true,
