...
export const ProcessPlanOperationHolderUsageLinkGetOperationHolderUsageLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessPlans('{ProcessPlanId}')/OperationHolderUsageLink('{OperationHolderUsageLinkId}')",
				],
			},
		},
		required: true,
