...
export const PtcMfgProcMgmtProcessPlanActionUpdateMpmOperationUsageLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/PTC.MfgProcMgmt.UpdateMPMOperationUsageLinks",
				],
			},
		},
		required: true,
