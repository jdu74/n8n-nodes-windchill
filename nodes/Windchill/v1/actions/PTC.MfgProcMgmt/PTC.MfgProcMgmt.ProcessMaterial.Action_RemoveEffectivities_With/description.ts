...
export const PtcMfgProcMgmtProcessMaterialActionRemoveEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessMaterials('{ProcessMaterialId}')/PTC.MfgProcMgmt.RemoveEffectivities",
				],
			},
		},
		required: true,
