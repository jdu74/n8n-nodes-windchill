...
export const SequenceHolderDocumentReferenceLinksGetDocumentReferenceLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /SequenceHolders('{SequenceHolderId}')/DocumentReferenceLinks",
				],
			},
		},
		required: true,
