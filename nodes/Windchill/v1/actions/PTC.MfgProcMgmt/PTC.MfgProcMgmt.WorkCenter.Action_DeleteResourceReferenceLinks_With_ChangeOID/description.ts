...
export const PtcMfgProcMgmtWorkCenterActionDeleteResourceReferenceLinksWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkCenters('{WorkCenterId}')/PTC.MfgProcMgmt.DeleteResourceReferenceLinks",
				],
			},
		},
		required: true,
