...
export const PtcMfgProcMgmtWorkCenterActionCreateUsesWithResourceUsesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkCenters('{WorkCenterId}')/PTC.MfgProcMgmt.CreateUses",
				],
			},
		},
		required: true,
