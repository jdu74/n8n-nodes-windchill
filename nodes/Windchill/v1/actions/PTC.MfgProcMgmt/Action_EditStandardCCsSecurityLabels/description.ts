...
export const ActionEditStandardCCsSecurityLabelsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /EditStandardCCsSecurityLabels',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* StandardCCs',
				name: 'StandardCCs',
				description: 'Standard C Cs - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
