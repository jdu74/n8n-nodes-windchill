...
export const PtcMfgProcMgmtOperationActionGetDocumentsWithInlineNavCriteriaWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.GetDocumentsWithInlineNavCriteria",
				],
			},
		},
		required: true,
