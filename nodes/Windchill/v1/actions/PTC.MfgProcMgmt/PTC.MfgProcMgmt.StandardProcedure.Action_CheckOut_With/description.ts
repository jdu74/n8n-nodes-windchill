...
export const PtcMfgProcMgmtStandardProcedureActionCheckOutWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.CheckOut",
				],
			},
		},
		required: true,
