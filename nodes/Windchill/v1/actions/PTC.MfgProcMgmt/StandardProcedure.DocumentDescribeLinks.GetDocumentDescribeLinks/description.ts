...
export const StandardProcedureDocumentDescribeLinksGetDocumentDescribeLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/DocumentDescribeLinks",
				],
			},
		},
		required: true,
