...
export const ProcessMaterialReferencesGetResourceReferenceLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessMaterials('{ProcessMaterialId}')/References('{ResourceReferenceLinkId}')",
				],
			},
		},
		required: true,
