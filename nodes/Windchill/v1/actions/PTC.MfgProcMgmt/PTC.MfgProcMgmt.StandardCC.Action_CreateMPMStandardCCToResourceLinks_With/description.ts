...
export const PtcMfgProcMgmtStandardCcActionCreateMpmStandardCcToResourceLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardCCs('{StandardCCId}')/PTC.MfgProcMgmt.CreateMPMStandardCCToResourceLinks",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: '* StandardCCToResourceLink',
				name: 'StandardCCToResourceLink',
				description: 'Standard Cc To Resource Link - array',
				type: 'json',
				default: '[\n\t{\n\t\t"CreatedOn": "string",\n\t\t"ID": "string",\n\t\t"LastModified": "string",\n\t\t"ObjectType": "string"\n\t}\n]',
			},
		],
