...
export const PtcMfgProcMgmtOperationActionUpdateMpmStandardProcedureLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.UpdateMPMStandardProcedureLinks",
				],
			},
		},
		required: true,
