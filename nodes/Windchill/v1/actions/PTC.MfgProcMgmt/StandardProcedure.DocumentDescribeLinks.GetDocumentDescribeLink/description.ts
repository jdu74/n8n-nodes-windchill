...
export const StandardProcedureDocumentDescribeLinksGetDocumentDescribeLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/DocumentDescribeLinks('{DocumentDescribeLinkId}')",
				],
			},
		},
		required: true,
