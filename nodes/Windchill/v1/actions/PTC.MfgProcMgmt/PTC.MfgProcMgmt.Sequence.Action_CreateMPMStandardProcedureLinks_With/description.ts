...
export const PtcMfgProcMgmtSequenceActionCreateMpmStandardProcedureLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.CreateMPMStandardProcedureLinks",
				],
			},
		},
		required: true,
