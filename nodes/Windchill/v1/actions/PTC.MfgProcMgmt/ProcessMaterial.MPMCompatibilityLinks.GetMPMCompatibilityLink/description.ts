...
export const ProcessMaterialMpmCompatibilityLinksGetMpmCompatibilityLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessMaterials('{ProcessMaterialId}')/MPMCompatibilityLinks('{MPMCompatibilityLinkId}')",
				],
			},
		},
		required: true,
