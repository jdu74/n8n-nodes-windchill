...
export const PtcMfgProcMgmtSequenceActionRemoveEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.RemoveEffectivities",
				],
			},
		},
		required: true,
