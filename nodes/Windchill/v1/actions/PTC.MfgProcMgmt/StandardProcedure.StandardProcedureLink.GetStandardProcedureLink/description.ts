...
export const StandardProcedureStandardProcedureLinkGetStandardProcedureLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/StandardProcedureLink('{StandardProcedureLinkId}')",
				],
			},
		},
		required: true,
