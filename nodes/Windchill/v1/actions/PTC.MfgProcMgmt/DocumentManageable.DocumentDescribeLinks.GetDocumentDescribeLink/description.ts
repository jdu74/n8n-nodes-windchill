...
export const DocumentManageableDocumentDescribeLinksGetDocumentDescribeLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /DocumentManageables('{DocumentManageableId}')/DocumentDescribeLinks('{DocumentDescribeLinkId}')",
				],
			},
		},
		required: true,
