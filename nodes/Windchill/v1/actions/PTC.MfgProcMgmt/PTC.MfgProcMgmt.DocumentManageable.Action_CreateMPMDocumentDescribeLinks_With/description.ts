...
export const PtcMfgProcMgmtDocumentManageableActionCreateMpmDocumentDescribeLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DocumentManageables('{DocumentManageableId}')/PTC.MfgProcMgmt.CreateMPMDocumentDescribeLinks",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: '* DocumentDescribeLink',
				name: 'DocumentDescribeLink',
				description: 'Document Describe Link - array',
				type: 'json',
				default: '[\n\t{\n\t\t"CreatedOn": "string",\n\t\t"ID": "string",\n\t\t"LastModified": "string",\n\t\t"Illustration": true,\n\t\t"DocOrder": 0\n\t}\n]',
			},
		],
