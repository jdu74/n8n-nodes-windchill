...
export const PtcMfgProcMgmtSequenceActionGetBopWithRelatedAssemblyNavigationCriteriaIdDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.GetBOP",
				],
			},
		},
		required: true,
