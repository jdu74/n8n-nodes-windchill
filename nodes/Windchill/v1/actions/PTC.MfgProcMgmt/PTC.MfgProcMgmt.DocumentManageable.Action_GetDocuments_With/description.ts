...
export const PtcMfgProcMgmtDocumentManageableActionGetDocumentsWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DocumentManageables('{DocumentManageableId}')/PTC.MfgProcMgmt.GetDocuments",
				],
			},
		},
		required: true,
