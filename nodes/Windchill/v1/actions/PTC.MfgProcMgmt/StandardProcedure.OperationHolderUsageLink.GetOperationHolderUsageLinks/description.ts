...
export const StandardProcedureOperationHolderUsageLinkGetOperationHolderUsageLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/OperationHolderUsageLink",
				],
			},
		},
		required: true,
