...
export const PtcMfgProcMgmtSequenceActionCreateMpmDocumentReferenceLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.CreateMPMDocumentReferenceLinks",
				],
			},
		},
		required: true,
