...
export const PtcMfgProcMgmtProcessPlanActionCreateMpmDocumentReferenceLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/PTC.MfgProcMgmt.CreateMPMDocumentReferenceLinks",
				],
			},
		},
		required: true,
