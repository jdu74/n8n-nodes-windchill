...
export const PtcMfgProcMgmtOperationFunctionOperatedOnPartsWithRelatedAssemblyNavigationCriteriaIdDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/PTC.MfgProcMgmt.OperatedOnParts(processPlanNavigationCriteriaId='{processPlanNavigationCriteriaId}',relatedAssemblyNavigationCriteriaId='{relatedAssemblyNavigationCriteriaId}')",
				],
			},
		},
		required: true,
