...
export const StandardProcedureEffectivitiesGetEffectivityDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/Effectivities('{EffectivityId}')",
				],
			},
		},
		required: true,
