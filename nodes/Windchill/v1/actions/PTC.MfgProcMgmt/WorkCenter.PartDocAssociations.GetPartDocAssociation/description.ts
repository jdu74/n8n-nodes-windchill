...
export const WorkCenterPartDocAssociationsGetPartDocAssociationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /WorkCenters('{WorkCenterId}')/PartDocAssociations('{PartDocAssociationId}')",
				],
			},
		},
		required: true,
