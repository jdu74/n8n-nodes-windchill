...
export const PtcMfgProcMgmtProcessPlanActionAssociateStandardOperationsWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/PTC.MfgProcMgmt.AssociateStandardOperations",
				],
			},
		},
		required: true,
