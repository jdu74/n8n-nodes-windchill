...
export const PtcMfgProcMgmtStandardProcedureActionUpdateMpmOperationUsageLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.UpdateMPMOperationUsageLinks",
				],
			},
		},
		required: true,
