...
export const PtcMfgProcMgmtOperationActionAssignCcFromProductWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.AssignCCFromProduct",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: 'AssociativeToSCCLinkOIDs',
				name: 'AssociativeToSCCLinkOIDs',
				description: 'Associative To Scc Link Oi Ds - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
