...
export const PtcMfgProcMgmtSequenceActionAssociateStandardOperationsWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.AssociateStandardOperations",
				],
			},
		},
		required: true,
