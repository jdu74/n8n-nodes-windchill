...
export const ActionDeleteMpmStdCcUsageToProcessPlanLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /DeleteMPMStdCCUsageToProcessPlanLinks',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			...
			{
				displayName: '* RoleAObject',
				name: 'RoleAObject',
				description: 'Role A Object - object',
				type: 'json',
				default: '{\n\t"ID": "string"\n}',
			},
		],
