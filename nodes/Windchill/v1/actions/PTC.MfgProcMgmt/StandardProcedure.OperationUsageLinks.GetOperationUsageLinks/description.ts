...
export const StandardProcedureOperationUsageLinksGetOperationUsageLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/OperationUsageLinks",
				],
			},
		},
		required: true,
