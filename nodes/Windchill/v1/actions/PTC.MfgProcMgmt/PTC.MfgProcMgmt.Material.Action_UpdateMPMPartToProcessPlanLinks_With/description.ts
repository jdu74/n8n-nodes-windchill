...
export const PtcMfgProcMgmtMaterialActionUpdateMpmPartToProcessPlanLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Materials('{MaterialId}')/PTC.MfgProcMgmt.UpdateMPMPartToProcessPlanLinks",
				],
			},
		},
		required: true,
