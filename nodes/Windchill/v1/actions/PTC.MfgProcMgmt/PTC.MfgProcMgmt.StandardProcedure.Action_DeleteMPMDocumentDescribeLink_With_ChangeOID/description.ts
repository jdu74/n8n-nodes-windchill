...
export const PtcMfgProcMgmtStandardProcedureActionDeleteMpmDocumentDescribeLinkWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.DeleteMPMDocumentDescribeLink",
				],
			},
		},
		required: true,
