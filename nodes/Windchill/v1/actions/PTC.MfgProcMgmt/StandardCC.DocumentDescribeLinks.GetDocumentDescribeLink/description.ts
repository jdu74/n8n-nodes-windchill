...
export const StandardCcDocumentDescribeLinksGetDocumentDescribeLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardCCs('{StandardCCId}')/DocumentDescribeLinks('{DocumentDescribeLinkId}')",
				],
			},
		},
		required: true,
