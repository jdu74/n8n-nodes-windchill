...
export const PtcMfgProcMgmtToolingActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Toolings('{ToolingId}')/PTC.MfgProcMgmt.CheckIn",
				],
			},
		},
		required: true,
