...
export const PtcMfgProcMgmtSequenceActionCreateMpmSequencesInSequenceContextWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.CreateMPMSequencesInSequenceContext",
				],
			},
		},
		required: true,
