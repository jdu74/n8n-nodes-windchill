...
export const PtcMfgProcMgmtSequenceHolderActionGetDocumentsWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /SequenceHolders('{SequenceHolderId}')/PTC.MfgProcMgmt.GetDocuments",
				],
			},
		},
		required: true,
