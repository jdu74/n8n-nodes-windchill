...
export const ProcessMaterialPartDocAssociationsGetPartDocAssociationsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessMaterials('{ProcessMaterialId}')/PartDocAssociations",
				],
			},
		},
		required: true,
