...
export const PtcMfgProcMgmtOperationFunctionConsumedToolingsWithRelatedAssemblyNavigationCriteriaIdDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/PTC.MfgProcMgmt.ConsumedToolings(processPlanNavigationCriteriaId='{processPlanNavigationCriteriaId}',relatedAssemblyNavigationCriteriaId='{relatedAssemblyNavigationCriteriaId}')",
				],
			},
		},
		required: true,
