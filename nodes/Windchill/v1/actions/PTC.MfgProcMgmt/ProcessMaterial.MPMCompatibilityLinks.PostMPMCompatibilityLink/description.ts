...
export const ProcessMaterialMpmCompatibilityLinksPostMpmCompatibilityLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessMaterials('{ProcessMaterialId}')/MPMCompatibilityLinks",
				],
			},
		},
		required: true,
