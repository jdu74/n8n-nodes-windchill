...
export const PtcMfgProcMgmtStandardProcedureActionCreateMpmSequencesInProcessPlanContextWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.CreateMPMSequencesInProcessPlanContext",
				],
			},
		},
		required: true,
