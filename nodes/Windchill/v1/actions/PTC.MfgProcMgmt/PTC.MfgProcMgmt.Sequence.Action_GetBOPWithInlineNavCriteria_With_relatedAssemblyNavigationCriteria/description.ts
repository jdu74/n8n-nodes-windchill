...
export const PtcMfgProcMgmtSequenceActionGetBopWithInlineNavCriteriaWithRelatedAssemblyNavigationCriteriaDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.GetBOPWithInlineNavCriteria",
				],
			},
		},
		required: true,
