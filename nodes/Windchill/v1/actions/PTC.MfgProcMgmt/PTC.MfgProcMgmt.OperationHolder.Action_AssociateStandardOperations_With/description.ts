...
export const PtcMfgProcMgmtOperationHolderActionAssociateStandardOperationsWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /OperationHolders('{OperationHolderId}')/PTC.MfgProcMgmt.AssociateStandardOperations",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: 'OperationUsageLink',
				name: 'OperationUsageLink',
				description: 'Operation Usage Link - array',
				type: 'json',
				default: '[\n\t{\n\t\t"OperationLabel": "string",\n\t\t"@odata.type": "string",\n\t\t"OperationHolder@odata.bind": "string",\n\t\t"Operation@odata.bind": "string"\n\t}\n]',
			},
		],
		displayOptions: {
			show: {
