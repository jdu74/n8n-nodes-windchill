...
export const PtcMfgProcMgmtStandardProcedureActionRemoveEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.RemoveEffectivities",
				],
			},
		},
		required: true,
