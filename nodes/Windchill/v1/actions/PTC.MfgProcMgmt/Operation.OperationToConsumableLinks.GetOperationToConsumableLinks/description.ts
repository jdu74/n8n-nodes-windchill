...
export const OperationOperationToConsumableLinksGetOperationToConsumableLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/OperationToConsumableLinks",
				],
			},
		},
		required: true,
