...
export const OperationOperationToConsumableLinksGetOperationToConsumableLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/OperationToConsumableLinks('{OperationToConsumableLinkId}')",
				],
			},
		},
		required: true,
