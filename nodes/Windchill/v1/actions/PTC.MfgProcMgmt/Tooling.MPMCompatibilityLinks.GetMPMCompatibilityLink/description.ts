...
export const ToolingMpmCompatibilityLinksGetMpmCompatibilityLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Toolings('{ToolingId}')/MPMCompatibilityLinks('{MPMCompatibilityLinkId}')",
				],
			},
		},
		required: true,
