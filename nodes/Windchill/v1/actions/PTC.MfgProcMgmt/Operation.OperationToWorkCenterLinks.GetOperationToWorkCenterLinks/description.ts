...
export const OperationOperationToWorkCenterLinksGetOperationToWorkCenterLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/OperationToWorkCenterLinks",
				],
			},
		},
		required: true,
