...
export const PtcMfgProcMgmtStandardProcedureActionCreateMpmPartToProcessPlanLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.CreateMPMPartToProcessPlanLinks",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: '* PartToProcessPlanLink',
				name: 'PartToProcessPlanLink',
				description: 'Part To Process Plan Link - array',
				type: 'json',
				default: '[\n\t{\n\t\t"CreatedOn": "string",\n\t\t"ID": "string",\n\t\t"LastModified": "string",\n\t\t"ObjectType": "string"\n\t}\n]',
			},
		],
