...
export const SkillMpmCompatibilityLinksGetMpmCompatibilityLinkDescription: INodeProperties[] = [
	{
		displayName: 'SkillId',
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Skills('{SkillId}')/MPMCompatibilityLinks('{MPMCompatibilityLinkId}')",
				],
			},
		},
		required: true,
