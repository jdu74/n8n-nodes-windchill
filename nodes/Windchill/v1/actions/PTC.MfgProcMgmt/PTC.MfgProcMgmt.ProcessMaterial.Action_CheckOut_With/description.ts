...
export const PtcMfgProcMgmtProcessMaterialActionCheckOutWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessMaterials('{ProcessMaterialId}')/PTC.MfgProcMgmt.CheckOut",
				],
			},
		},
		required: true,
