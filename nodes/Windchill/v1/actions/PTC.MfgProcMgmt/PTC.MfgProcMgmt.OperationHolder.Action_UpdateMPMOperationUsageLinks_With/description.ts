...
export const PtcMfgProcMgmtOperationHolderActionUpdateMpmOperationUsageLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /OperationHolders('{OperationHolderId}')/PTC.MfgProcMgmt.UpdateMPMOperationUsageLinks",
				],
			},
		},
		required: true,
