...
export const OperationHolderDocumentDescribeLinksGetDocumentDescribeLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /OperationHolders('{OperationHolderId}')/DocumentDescribeLinks",
				],
			},
		},
		required: true,
