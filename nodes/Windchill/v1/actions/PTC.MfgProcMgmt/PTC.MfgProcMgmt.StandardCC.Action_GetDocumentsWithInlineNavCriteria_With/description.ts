...
export const PtcMfgProcMgmtStandardCcActionGetDocumentsWithInlineNavCriteriaWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardCCs('{StandardCCId}')/PTC.MfgProcMgmt.GetDocumentsWithInlineNavCriteria",
				],
			},
		},
		required: true,
