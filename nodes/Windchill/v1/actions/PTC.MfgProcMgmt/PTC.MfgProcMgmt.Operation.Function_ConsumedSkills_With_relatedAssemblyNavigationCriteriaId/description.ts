...
export const PtcMfgProcMgmtOperationFunctionConsumedSkillsWithRelatedAssemblyNavigationCriteriaIdDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/PTC.MfgProcMgmt.ConsumedSkills(processPlanNavigationCriteriaId='{processPlanNavigationCriteriaId}',relatedAssemblyNavigationCriteriaId='{relatedAssemblyNavigationCriteriaId}')",
				],
			},
		},
		required: true,
