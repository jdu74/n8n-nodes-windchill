...
export const PtcMfgProcMgmtOperationHolderActionCreateMpmStandardProcedureLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /OperationHolders('{OperationHolderId}')/PTC.MfgProcMgmt.CreateMPMStandardProcedureLinks",
				],
			},
		},
		required: true,
