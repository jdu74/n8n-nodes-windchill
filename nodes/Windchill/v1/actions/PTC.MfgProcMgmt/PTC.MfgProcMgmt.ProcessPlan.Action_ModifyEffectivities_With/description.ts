...
export const PtcMfgProcMgmtProcessPlanActionModifyEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/PTC.MfgProcMgmt.ModifyEffectivities",
				],
			},
		},
		required: true,
