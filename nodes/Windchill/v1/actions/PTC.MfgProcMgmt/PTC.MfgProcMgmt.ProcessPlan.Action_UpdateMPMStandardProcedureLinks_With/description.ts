...
export const PtcMfgProcMgmtProcessPlanActionUpdateMpmStandardProcedureLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/PTC.MfgProcMgmt.UpdateMPMStandardProcedureLinks",
				],
			},
		},
		required: true,
