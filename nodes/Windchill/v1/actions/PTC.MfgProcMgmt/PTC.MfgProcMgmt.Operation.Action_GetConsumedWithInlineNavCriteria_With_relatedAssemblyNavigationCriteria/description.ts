...
export const PtcMfgProcMgmtOperationActionGetConsumedWithInlineNavCriteriaWithRelatedAssemblyNavigationCriteriaDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.GetConsumedWithInlineNavCriteria",
				],
			},
		},
		required: true,
