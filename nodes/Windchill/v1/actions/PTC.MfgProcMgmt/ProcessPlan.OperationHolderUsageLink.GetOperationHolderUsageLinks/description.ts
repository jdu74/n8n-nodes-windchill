...
export const ProcessPlanOperationHolderUsageLinkGetOperationHolderUsageLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessPlans('{ProcessPlanId}')/OperationHolderUsageLink",
				],
			},
		},
		required: true,
