...
export const PtcMfgProcMgmtStandardCcActionCreateMpmDocumentDescribeLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardCCs('{StandardCCId}')/PTC.MfgProcMgmt.CreateMPMDocumentDescribeLinks",
				],
			},
		},
		required: true,
