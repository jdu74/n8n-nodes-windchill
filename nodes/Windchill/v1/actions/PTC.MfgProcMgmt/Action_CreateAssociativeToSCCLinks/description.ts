...
export const ActionCreateAssociativeToSccLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /CreateAssociativeToSCCLinks',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* associativeOID',
				name: 'associativeOID',
				description: 'Associative Oid - object',
				type: 'json',
				default: '{\n\t"ID": "string"\n}',
			},
			{
				displayName: 'associativeToStandardCCLinks',
				name: 'associativeToStandardCCLinks',
				description: 'Associative To Standard Cc Links - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ApplicableParts": "string",\n\t\t"ModelItemContainerMasterReference": "string",\n\t\t"ModelItemMasterReference": "string",\n\t\t"OccurrencePaths": "string",\n\t\t"UniqueIdentifier": "string",\n\t\t"@odata.type": "string",\n\t\t"SCC@odata.bind": "string"\n\t}\n]',
			},
		],
		displayOptions: {
			show: {
