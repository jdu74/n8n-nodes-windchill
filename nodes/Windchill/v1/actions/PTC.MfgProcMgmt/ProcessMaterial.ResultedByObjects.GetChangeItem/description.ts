...
export const ProcessMaterialResultedByObjectsGetChangeItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessMaterials('{ProcessMaterialId}')/ResultedByObjects('{ChangeItemId}')",
				],
			},
		},
		required: true,
