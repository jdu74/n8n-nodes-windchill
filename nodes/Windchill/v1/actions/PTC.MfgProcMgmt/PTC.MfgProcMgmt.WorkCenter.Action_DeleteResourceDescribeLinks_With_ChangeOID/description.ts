...
export const PtcMfgProcMgmtWorkCenterActionDeleteResourceDescribeLinksWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkCenters('{WorkCenterId}')/PTC.MfgProcMgmt.DeleteResourceDescribeLinks",
				],
			},
		},
		required: true,
