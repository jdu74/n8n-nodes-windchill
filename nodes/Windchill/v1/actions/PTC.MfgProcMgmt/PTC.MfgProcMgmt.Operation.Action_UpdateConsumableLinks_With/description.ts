...
export const PtcMfgProcMgmtOperationActionUpdateConsumableLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.UpdateConsumableLinks",
				],
			},
		},
		required: true,
