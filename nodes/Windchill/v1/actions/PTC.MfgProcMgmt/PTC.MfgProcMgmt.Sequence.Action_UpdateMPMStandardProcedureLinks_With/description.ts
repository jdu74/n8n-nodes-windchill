...
export const PtcMfgProcMgmtSequenceActionUpdateMpmStandardProcedureLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.UpdateMPMStandardProcedureLinks",
				],
			},
		},
		required: true,
