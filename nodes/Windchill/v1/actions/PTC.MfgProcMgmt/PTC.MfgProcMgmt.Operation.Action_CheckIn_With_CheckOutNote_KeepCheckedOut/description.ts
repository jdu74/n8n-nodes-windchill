...
export const PtcMfgProcMgmtOperationActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.CheckIn",
				],
			},
		},
		required: true,
