...
export const PtcMfgProcMgmtMaterialActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Materials('{MaterialId}')/PTC.MfgProcMgmt.CheckIn",
				],
			},
		},
		required: true,
