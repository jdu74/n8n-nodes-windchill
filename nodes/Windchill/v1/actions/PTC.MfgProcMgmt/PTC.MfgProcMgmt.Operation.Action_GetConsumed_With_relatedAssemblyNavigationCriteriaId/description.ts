...
export const PtcMfgProcMgmtOperationActionGetConsumedWithRelatedAssemblyNavigationCriteriaIdDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.GetConsumed",
				],
			},
		},
		required: true,
