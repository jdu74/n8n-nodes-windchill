...
export const PtcMfgProcMgmtSequenceActionCreateMpmDocumentDescribeLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.CreateMPMDocumentDescribeLinks",
				],
			},
		},
		required: true,
