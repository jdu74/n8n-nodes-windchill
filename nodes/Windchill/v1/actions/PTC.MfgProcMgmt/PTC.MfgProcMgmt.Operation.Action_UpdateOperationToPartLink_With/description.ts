...
export const PtcMfgProcMgmtOperationActionUpdateOperationToPartLinkWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.UpdateOperationToPartLink",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: 'OperationToPartLink',
				name: 'OperationToPartLink',
				description: 'Operation To Part Link - array',
				type: 'json',
