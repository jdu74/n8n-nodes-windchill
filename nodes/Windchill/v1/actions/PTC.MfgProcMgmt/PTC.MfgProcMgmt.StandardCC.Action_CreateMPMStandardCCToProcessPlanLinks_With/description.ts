...
export const PtcMfgProcMgmtStandardCcActionCreateMpmStandardCcToProcessPlanLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardCCs('{StandardCCId}')/PTC.MfgProcMgmt.CreateMPMStandardCCToProcessPlanLinks",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: 'StandardCCToProcessPlanLink',
				name: 'StandardCCToProcessPlanLink',
				description: 'Standard Cc To Process Plan Link - array',
				type: 'json',
