...
export const ResourceMpmCompatibilityLinksGetMpmCompatibilityLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Resources('{ResourceId}')/MPMCompatibilityLinks('{MPMCompatibilityLinkId}')",
				],
			},
		},
		required: true,
