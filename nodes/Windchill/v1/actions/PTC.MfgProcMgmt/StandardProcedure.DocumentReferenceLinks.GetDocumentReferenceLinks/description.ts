...
export const StandardProcedureDocumentReferenceLinksGetDocumentReferenceLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/DocumentReferenceLinks",
				],
			},
		},
		required: true,
