...
export const PtcMfgProcMgmtSequenceActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.CheckIn",
				],
			},
		},
		required: true,
