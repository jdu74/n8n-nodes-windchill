...
export const PtcMfgProcMgmtOperationHolderActionGetDocumentsWithInlineNavCriteriaWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /OperationHolders('{OperationHolderId}')/PTC.MfgProcMgmt.GetDocumentsWithInlineNavCriteria",
				],
			},
		},
		required: true,
