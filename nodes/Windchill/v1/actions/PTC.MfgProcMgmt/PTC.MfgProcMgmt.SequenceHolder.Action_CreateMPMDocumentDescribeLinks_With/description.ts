...
export const PtcMfgProcMgmtSequenceHolderActionCreateMpmDocumentDescribeLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /SequenceHolders('{SequenceHolderId}')/PTC.MfgProcMgmt.CreateMPMDocumentDescribeLinks",
				],
			},
		},
		required: true,
