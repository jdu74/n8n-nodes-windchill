...
export const PtcMfgProcMgmtOperationActionCreateMpmDocumentReferenceLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.CreateMPMDocumentReferenceLinks",
				],
			},
		},
		required: true,
