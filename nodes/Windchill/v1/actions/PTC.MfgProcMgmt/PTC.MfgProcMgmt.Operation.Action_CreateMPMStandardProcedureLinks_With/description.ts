...
export const PtcMfgProcMgmtOperationActionCreateMpmStandardProcedureLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.CreateMPMStandardProcedureLinks",
				],
			},
		},
		required: true,
