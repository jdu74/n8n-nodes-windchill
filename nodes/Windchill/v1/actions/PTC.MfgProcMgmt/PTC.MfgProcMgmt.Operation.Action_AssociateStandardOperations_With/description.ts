...
export const PtcMfgProcMgmtOperationActionAssociateStandardOperationsWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.AssociateStandardOperations",
				],
			},
		},
		required: true,
