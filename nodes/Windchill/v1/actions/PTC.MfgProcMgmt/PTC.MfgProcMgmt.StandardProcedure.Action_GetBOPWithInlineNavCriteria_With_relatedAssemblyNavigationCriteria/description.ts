...
export const PtcMfgProcMgmtStandardProcedureActionGetBopWithInlineNavCriteriaWithRelatedAssemblyNavigationCriteriaDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.GetBOPWithInlineNavCriteria",
				],
			},
		},
		required: true,
