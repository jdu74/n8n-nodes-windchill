...
export const PtcMfgProcMgmtWorkCenterActionCreateMpmCompatibilityLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkCenters('{WorkCenterId}')/PTC.MfgProcMgmt.CreateMPMCompatibilityLinks",
				],
			},
		},
		required: true,
