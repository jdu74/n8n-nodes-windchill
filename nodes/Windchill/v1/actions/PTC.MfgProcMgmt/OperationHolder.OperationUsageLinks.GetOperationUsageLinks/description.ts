...
export const OperationHolderOperationUsageLinksGetOperationUsageLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /OperationHolders('{OperationHolderId}')/OperationUsageLinks",
				],
			},
		},
		required: true,
