...
export const OperationOperationHolderUsageLinkGetOperationHolderUsageLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/OperationHolderUsageLink",
				],
			},
		},
		required: true,
