...
export const PtcMfgProcMgmtResourceActionDeleteResourceReferenceLinksWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Resources('{ResourceId}')/PTC.MfgProcMgmt.DeleteResourceReferenceLinks",
				],
			},
		},
		required: true,
