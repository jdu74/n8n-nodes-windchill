...
export const PtcMfgProcMgmtStandardProcedureActionCreateMpmDocumentReferenceLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.CreateMPMDocumentReferenceLinks",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: '* DocumentReferenceLink',
				name: 'DocumentReferenceLink',
				description: 'Document Reference Link - array',
				type: 'json',
				default: '[\n\t{\n\t\t"CreatedOn": "string",\n\t\t"ID": "string",\n\t\t"LastModified": "string"\n\t}\n]',
			},
		],
