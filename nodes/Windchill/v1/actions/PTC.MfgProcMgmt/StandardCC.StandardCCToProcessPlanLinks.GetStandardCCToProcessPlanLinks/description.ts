...
export const StandardCcStandardCcToProcessPlanLinksGetStandardCcToProcessPlanLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardCCs('{StandardCCId}')/StandardCCToProcessPlanLinks",
				],
			},
		},
		required: true,
