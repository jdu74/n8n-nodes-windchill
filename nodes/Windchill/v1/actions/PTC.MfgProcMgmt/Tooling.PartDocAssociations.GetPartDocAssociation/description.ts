...
export const ToolingPartDocAssociationsGetPartDocAssociationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Toolings('{ToolingId}')/PartDocAssociations('{PartDocAssociationId}')",
				],
			},
		},
		required: true,
