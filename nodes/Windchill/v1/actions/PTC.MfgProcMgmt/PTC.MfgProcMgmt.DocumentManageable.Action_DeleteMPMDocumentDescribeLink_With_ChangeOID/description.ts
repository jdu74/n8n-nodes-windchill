...
export const PtcMfgProcMgmtDocumentManageableActionDeleteMpmDocumentDescribeLinkWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DocumentManageables('{DocumentManageableId}')/PTC.MfgProcMgmt.DeleteMPMDocumentDescribeLink",
				],
			},
		},
		required: true,
