...
export const PtcMfgProcMgmtOperationActionGetBopWithInlineNavCriteriaWithRelatedAssemblyNavigationCriteriaDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.GetBOPWithInlineNavCriteria",
				],
			},
		},
		required: true,
