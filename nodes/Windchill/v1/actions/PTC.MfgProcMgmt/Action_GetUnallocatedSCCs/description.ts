...
export const ActionGetUnallocatedScCsDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				name: 'ProcessPlan',
				description: 'Process Plan - string',
				type: 'string',
				default: '',
			},
			{
				...
				description: 'Process Plan Navigation Criteria - string',
				type: 'string',
				default: '',
			},
			{
				...
				description: 'Related Assembly Navigation Criteria - string',
				type: 'string',
				default: '',
			},
		],
	...
	},
	{
		...
		type: 'json',
		default: '{\n\t"ProcessPlan": "string",\n\t"Operation": "string",\n\t"ProcessPlanNavigationCriteria": "string",\n\t"RelatedAssemblyNavigationCriteria": "string"\n}',
		typeOptions: {
			alwaysOpenEditWindow: true,
		},
		displayOptions: {
