...
export const PtcMfgProcMgmtOperationActionDeleteOperationToOperatedPartLinksWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Operations('{OperationId}')/PTC.MfgProcMgmt.DeleteOperationToOperatedPartLinks",
				],
			},
		},
		required: true,
