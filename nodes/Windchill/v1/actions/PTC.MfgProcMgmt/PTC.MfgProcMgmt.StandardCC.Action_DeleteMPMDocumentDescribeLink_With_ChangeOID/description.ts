...
export const PtcMfgProcMgmtStandardCcActionDeleteMpmDocumentDescribeLinkWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardCCs('{StandardCCId}')/PTC.MfgProcMgmt.DeleteMPMDocumentDescribeLink",
				],
			},
		},
		required: true,
