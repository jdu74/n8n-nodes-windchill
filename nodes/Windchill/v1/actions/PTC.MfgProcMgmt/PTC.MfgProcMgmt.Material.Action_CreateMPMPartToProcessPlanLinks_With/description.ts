...
export const PtcMfgProcMgmtMaterialActionCreateMpmPartToProcessPlanLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Materials('{MaterialId}')/PTC.MfgProcMgmt.CreateMPMPartToProcessPlanLinks",
				],
			},
		},
		required: true,
