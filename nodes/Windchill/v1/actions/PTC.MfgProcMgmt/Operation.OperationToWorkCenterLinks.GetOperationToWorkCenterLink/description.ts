...
export const OperationOperationToWorkCenterLinksGetOperationToWorkCenterLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/OperationToWorkCenterLinks('{OperationToWorkCenterLinkId}')",
				],
			},
		},
		required: true,
