...
export const DocumentManageableDocumentReferenceLinksGetDocumentReferenceLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /DocumentManageables('{DocumentManageableId}')/DocumentReferenceLinks",
				],
			},
		},
		required: true,
