...
export const ProcessPlanStandardProcedureLinkPostStandardProcedureLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/StandardProcedureLink",
				],
			},
		},
		required: true,
