...
export const PtcMfgProcMgmtWorkCenterActionModifyEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkCenters('{WorkCenterId}')/PTC.MfgProcMgmt.ModifyEffectivities",
				],
			},
		},
		required: true,
