...
export const SequenceHolderDocumentDescribeLinksGetDocumentDescribeLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /SequenceHolders('{SequenceHolderId}')/DocumentDescribeLinks",
				],
			},
		},
		required: true,
