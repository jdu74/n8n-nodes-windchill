...
export const PtcMfgProcMgmtProcessMaterialActionModifyEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessMaterials('{ProcessMaterialId}')/PTC.MfgProcMgmt.ModifyEffectivities",
				],
			},
		},
		required: true,
