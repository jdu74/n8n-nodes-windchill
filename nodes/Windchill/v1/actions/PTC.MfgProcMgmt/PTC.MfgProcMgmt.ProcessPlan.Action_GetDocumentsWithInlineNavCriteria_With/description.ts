...
export const PtcMfgProcMgmtProcessPlanActionGetDocumentsWithInlineNavCriteriaWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProcessPlans('{ProcessPlanId}')/PTC.MfgProcMgmt.GetDocumentsWithInlineNavCriteria",
				],
			},
		},
		required: true,
