...
export const OperationHolderDocumentReferenceLinksGetDocumentReferenceLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /OperationHolders('{OperationHolderId}')/DocumentReferenceLinks",
				],
			},
		},
		required: true,
