...
export const PtcMfgProcMgmtResourceActionDeleteResourceDescribeLinksWithChangeOidDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Resources('{ResourceId}')/PTC.MfgProcMgmt.DeleteResourceDescribeLinks",
				],
			},
		},
		required: true,
