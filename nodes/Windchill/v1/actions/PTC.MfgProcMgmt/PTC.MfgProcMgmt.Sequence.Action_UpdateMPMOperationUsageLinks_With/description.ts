...
export const PtcMfgProcMgmtSequenceActionUpdateMpmOperationUsageLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Sequences('{SequenceId}')/PTC.MfgProcMgmt.UpdateMPMOperationUsageLinks",
				],
			},
		},
		required: true,
