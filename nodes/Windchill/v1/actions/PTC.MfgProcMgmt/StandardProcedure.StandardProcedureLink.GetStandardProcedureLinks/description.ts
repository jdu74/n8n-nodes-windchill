...
export const StandardProcedureStandardProcedureLinkGetStandardProcedureLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/StandardProcedureLink",
				],
			},
		},
		required: true,
