...
export const ProcessMaterialPartDocAssociationsGetPartDocAssociationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProcessMaterials('{ProcessMaterialId}')/PartDocAssociations('{PartDocAssociationId}')",
				],
			},
		},
		required: true,
