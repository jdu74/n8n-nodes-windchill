...
export const PtcMfgProcMgmtStandardProcedureActionGetDocumentsWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.MfgProcMgmt.GetDocuments",
				],
			},
		},
		required: true,
