...
export const PtcMfgProcMgmtWorkCenterActionCreateResourceDescribeDocumentLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkCenters('{WorkCenterId}')/PTC.MfgProcMgmt.CreateResourceDescribeDocumentLinks",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			{
				displayName: '* ResourceDescribeLink',
				name: 'ResourceDescribeLink',
				description: 'Resource Describe Link - array',
				type: 'json',
