...
export const PtcMfgProcMgmtResourceActionCreateResourceReferenceDocumentLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Resources('{ResourceId}')/PTC.MfgProcMgmt.CreateResourceReferenceDocumentLinks",
				],
			},
		},
		required: true,
