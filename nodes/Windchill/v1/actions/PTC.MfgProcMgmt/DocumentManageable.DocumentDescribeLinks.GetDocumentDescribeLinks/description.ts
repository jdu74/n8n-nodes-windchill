...
export const DocumentManageableDocumentDescribeLinksGetDocumentDescribeLinksDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /DocumentManageables('{DocumentManageableId}')/DocumentDescribeLinks",
				],
			},
		},
		required: true,
