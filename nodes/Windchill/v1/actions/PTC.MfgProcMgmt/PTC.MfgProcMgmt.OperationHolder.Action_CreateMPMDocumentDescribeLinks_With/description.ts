...
export const PtcMfgProcMgmtOperationHolderActionCreateMpmDocumentDescribeLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /OperationHolders('{OperationHolderId}')/PTC.MfgProcMgmt.CreateMPMDocumentDescribeLinks",
				],
			},
		},
		required: true,
