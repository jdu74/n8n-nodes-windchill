...
export const PtcMfgProcMgmtStandardCcActionUpdateMpmStandardCcToProcessPlanLinksWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardCCs('{StandardCCId}')/PTC.MfgProcMgmt.UpdateMPMStandardCCToProcessPlanLinks",
				],
			},
		},
		required: true,
