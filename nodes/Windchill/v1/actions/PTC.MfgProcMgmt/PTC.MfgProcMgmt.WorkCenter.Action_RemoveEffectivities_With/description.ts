...
export const PtcMfgProcMgmtWorkCenterActionRemoveEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkCenters('{WorkCenterId}')/PTC.MfgProcMgmt.RemoveEffectivities",
				],
			},
		},
		required: true,
