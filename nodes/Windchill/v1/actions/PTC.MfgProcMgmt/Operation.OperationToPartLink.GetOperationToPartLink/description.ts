...
export const OperationOperationToPartLinkGetOperationToPartLinkDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Operations('{OperationId}')/OperationToPartLink('{OperationToPartLinkId}')",
				],
			},
		},
		required: true,
