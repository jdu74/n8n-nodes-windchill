...
export const ActionAssociateDistributionTargetDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /AssociateDistributionTarget',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* DistributionTargetAssignables',
				name: 'DistributionTargetAssignables',
				description: 'Distribution Target Assignables - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
			{
				displayName: '* DistributionTargets',
				name: 'DistributionTargets',
				description: 'Distribution Targets - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
