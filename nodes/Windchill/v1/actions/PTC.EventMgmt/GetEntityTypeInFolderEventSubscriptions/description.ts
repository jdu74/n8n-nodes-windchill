...
export const GetEntityTypeInFolderEventSubscriptionsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'GET /EventSubscriptions/PTC.EventMgmt.EntityTypeInFolderEventSubscription',
				],
			},
		},
	},
