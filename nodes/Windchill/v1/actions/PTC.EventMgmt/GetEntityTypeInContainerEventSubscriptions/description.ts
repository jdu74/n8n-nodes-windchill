...
export const GetEntityTypeInContainerEventSubscriptionsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'GET /EventSubscriptions/PTC.EventMgmt.EntityTypeInContainerEventSubscription',
				],
			},
		},
	},
