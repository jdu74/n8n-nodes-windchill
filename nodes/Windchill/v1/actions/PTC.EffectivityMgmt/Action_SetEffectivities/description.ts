...
export const ActionSetEffectivitiesDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			...
			{
				displayName: '* EffectivityManaged',
				name: 'EffectivityManaged',
				description: 'Effectivity Managed - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
