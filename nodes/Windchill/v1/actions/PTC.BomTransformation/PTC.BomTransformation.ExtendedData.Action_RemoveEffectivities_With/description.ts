...
export const PtcBomTransformationExtendedDataActionRemoveEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ExtendedDatas('{ExtendedDataId}')/PTC.BomTransformation.RemoveEffectivities",
				],
			},
		},
		required: true,
