...
export const PtcBomTransformationDepartmentDataActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DepartmentDatas('{DepartmentDataId}')/PTC.BomTransformation.CheckIn",
				],
			},
		},
		required: true,
