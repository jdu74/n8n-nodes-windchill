...
export const PtcBomTransformationDepartmentDataActionCheckOutWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DepartmentDatas('{DepartmentDataId}')/PTC.BomTransformation.CheckOut",
				],
			},
		},
		required: true,
