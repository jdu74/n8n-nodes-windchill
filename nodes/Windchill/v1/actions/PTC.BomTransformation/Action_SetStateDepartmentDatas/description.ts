...
export const ActionSetStateDepartmentDatasDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			{
				displayName: '* DepartmentDatas',
				name: 'DepartmentDatas',
				description: 'Department Datas - array',
				type: 'json',
