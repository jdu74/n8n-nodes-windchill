...
export const PtcBomTransformationDepartmentDataActionModifyEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DepartmentDatas('{DepartmentDataId}')/PTC.BomTransformation.ModifyEffectivities",
				],
			},
		},
		required: true,
