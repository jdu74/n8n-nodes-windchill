...
export const ActionCreateDepartmentDataForPlantDataDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /CreateDepartmentDataForPlantData',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			...
			{
				displayName: '* plantData',
				name: 'plantData',
				description: 'Plant Data - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
