...
export const ActionUpdateCommonPropertiesForExtendedDatasDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /UpdateCommonPropertiesForExtendedDatas',
				],
			},
		},
	},
		...
		options: [
			{
				...
				name: 'ExtendedData',
				description: 'Extended Data - array',
				type: 'json',
