...
export const PtcBomTransformationXbomPartActionGetManufacturingBomWithRelatedItemsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /XBOMParts('{XBOMPartId}')/PTC.BomTransformation.GetManufacturingBOM",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				name: 'RelatedItems',
				description: 'Related Items - array',
				type: 'json',
				default: '[\n\t"string"\n]',
			},
		],
