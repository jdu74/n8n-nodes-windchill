...
export const PtcBomTransformationDepartmentDataActionRemoveEffectivitiesWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DepartmentDatas('{DepartmentDataId}')/PTC.BomTransformation.RemoveEffectivities",
				],
			},
		},
		required: true,
