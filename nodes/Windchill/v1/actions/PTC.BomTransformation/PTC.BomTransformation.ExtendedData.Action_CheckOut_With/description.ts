...
export const PtcBomTransformationExtendedDataActionCheckOutWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ExtendedDatas('{ExtendedDataId}')/PTC.BomTransformation.CheckOut",
				],
			},
		},
		required: true,
