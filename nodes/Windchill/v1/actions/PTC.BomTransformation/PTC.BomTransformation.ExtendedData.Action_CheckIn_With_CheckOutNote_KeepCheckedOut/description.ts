...
export const PtcBomTransformationExtendedDataActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ExtendedDatas('{ExtendedDataId}')/PTC.BomTransformation.CheckIn",
				],
			},
		},
		required: true,
