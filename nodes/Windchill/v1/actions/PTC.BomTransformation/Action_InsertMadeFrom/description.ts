...
export const ActionInsertMadeFromDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			...
			{
				displayName: '* MadeFromAssociations',
				name: 'MadeFromAssociations',
				description: 'Made From Associations - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
