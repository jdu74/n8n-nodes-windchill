...
export const ActionReassignWorkItemsDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				name: 'RestrictReassignToRole',
				description: 'Whether Restrict Reassign To Role - boolean',
				type: 'boolean',
				default: false,
			},
			{
