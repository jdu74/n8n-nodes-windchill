...
export const PtcWorkflowWorkItemActionSaveWorkitemWithWorkitemCommentVoteActionAutomateFastTrackVariablesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /WorkItems('{WorkItemId}')/PTC.Workflow.SaveWorkitem",
				],
			},
		},
		required: true,
