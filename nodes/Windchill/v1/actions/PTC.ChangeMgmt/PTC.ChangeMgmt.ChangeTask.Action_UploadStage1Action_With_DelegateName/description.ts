...
export const PtcChangeMgmtChangeTaskActionUploadStage1ActionWithDelegateNameDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ChangeTasks('{ChangeTaskId}')/PTC.ChangeMgmt.UploadStage1Action",
				],
			},
		},
		required: true,
