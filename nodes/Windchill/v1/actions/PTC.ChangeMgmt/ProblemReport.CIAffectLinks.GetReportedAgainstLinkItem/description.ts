...
export const ProblemReportCiAffectLinksGetReportedAgainstLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProblemReports('{ProblemReportId}')/CIAffectLinks('{ReportedAgainstLinkItemId}')",
				],
			},
		},
		required: true,
