...
export const ChangeableResultedByChangeObjectsGetChangeItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Changeables('{ChangeableId}')/ResultedByChangeObjects('{ChangeItemId}')",
				],
			},
		},
		required: true,
