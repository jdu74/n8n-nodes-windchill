...
export const GenericChangeRequestVersionsGetChangeItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/Versions('{ChangeItemId}')",
				],
			},
		},
		required: true,
