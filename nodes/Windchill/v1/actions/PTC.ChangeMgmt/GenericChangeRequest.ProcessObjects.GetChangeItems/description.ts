...
export const GenericChangeRequestProcessObjectsGetChangeItemsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/ProcessObjects",
				],
			},
		},
		required: true,
