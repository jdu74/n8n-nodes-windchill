...
export const PtcChangeMgmtProblemReportActionUploadStage3ActionWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProblemReports('{ProblemReportId}')/PTC.ChangeMgmt.UploadStage3Action",
				],
			},
		},
		required: true,
