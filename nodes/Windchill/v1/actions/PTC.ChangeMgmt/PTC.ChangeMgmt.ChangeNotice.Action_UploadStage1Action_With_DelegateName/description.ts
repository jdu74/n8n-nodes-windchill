...
export const PtcChangeMgmtChangeNoticeActionUploadStage1ActionWithDelegateNameDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ChangeNotices('{ChangeNoticeId}')/PTC.ChangeMgmt.UploadStage1Action",
				],
			},
		},
		required: true,
