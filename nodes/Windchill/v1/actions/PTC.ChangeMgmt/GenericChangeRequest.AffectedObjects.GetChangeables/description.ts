...
export const GenericChangeRequestAffectedObjectsGetChangeablesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/AffectedObjects",
				],
			},
		},
		required: true,
