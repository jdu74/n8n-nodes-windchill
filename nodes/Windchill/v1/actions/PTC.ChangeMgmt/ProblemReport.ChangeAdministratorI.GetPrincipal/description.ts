...
export const ProblemReportChangeAdministratorIGetPrincipalDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ProblemReports('{ProblemReportId}')/ChangeAdministratorI('{PrincipalId}')",
				],
			},
		},
		required: true,
