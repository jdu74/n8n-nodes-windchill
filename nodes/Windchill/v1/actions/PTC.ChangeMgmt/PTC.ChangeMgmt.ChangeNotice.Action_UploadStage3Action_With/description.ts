...
export const PtcChangeMgmtChangeNoticeActionUploadStage3ActionWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ChangeNotices('{ChangeNoticeId}')/PTC.ChangeMgmt.UploadStage3Action",
				],
			},
		},
		required: true,
