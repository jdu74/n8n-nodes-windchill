...
export const GenericChangeRequestProcessLinksGetProcessLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/ProcessLinks('{ProcessLinkItemId}')",
				],
			},
		},
		required: true,
