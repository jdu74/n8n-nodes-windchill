...
export const PtcChangeMgmtVarianceActionUploadStage1ActionWithDelegateNameDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Variances('{VarianceId}')/PTC.ChangeMgmt.UploadStage1Action",
				],
			},
		},
		required: true,
