...
export const ActionEditVariancesSecurityLabelsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /EditVariancesSecurityLabels',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* Variances',
				name: 'Variances',
				description: 'Variances - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
