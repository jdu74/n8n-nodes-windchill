...
export const ChangeNoticeChangeAdministratorIiGetPrincipalDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeNotices('{ChangeNoticeId}')/ChangeAdministratorII('{PrincipalId}')",
				],
			},
		},
		required: true,
