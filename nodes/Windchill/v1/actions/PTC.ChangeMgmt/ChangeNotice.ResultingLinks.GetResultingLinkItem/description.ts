...
export const ChangeNoticeResultingLinksGetResultingLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeNotices('{ChangeNoticeId}')/ResultingLinks('{ResultingLinkItemId}')",
				],
			},
		},
		required: true,
