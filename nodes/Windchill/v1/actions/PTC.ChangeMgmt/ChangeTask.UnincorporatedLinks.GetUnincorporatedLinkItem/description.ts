...
export const ChangeTaskUnincorporatedLinksGetUnincorporatedLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeTasks('{ChangeTaskId}')/UnincorporatedLinks('{UnincorporatedLinkItemId}')",
				],
			},
		},
		required: true,
