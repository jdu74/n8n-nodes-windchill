...
export const ChangeTaskResultingLinksUpdateResultingLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /ChangeTasks('{ChangeTaskId}')/ResultingLinks('{ResultingLinkItemId}')",
				],
			},
		},
		required: true,
