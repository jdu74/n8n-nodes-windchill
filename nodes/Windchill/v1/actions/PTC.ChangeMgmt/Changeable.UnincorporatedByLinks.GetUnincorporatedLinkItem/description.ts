...
export const ChangeableUnincorporatedByLinksGetUnincorporatedLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Changeables('{ChangeableId}')/UnincorporatedByLinks('{UnincorporatedLinkItemId}')",
				],
			},
		},
		required: true,
