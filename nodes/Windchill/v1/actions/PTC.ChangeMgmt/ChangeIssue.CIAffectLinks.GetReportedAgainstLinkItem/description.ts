...
export const ChangeIssueCiAffectLinksGetReportedAgainstLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeIssues('{ChangeIssueId}')/CIAffectLinks('{ReportedAgainstLinkItemId}')",
				],
			},
		},
		required: true,
