...
export const GenericChangeRequestAffectsLinksGetAffectsLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/AffectsLinks('{AffectsLinkItemId}')",
				],
			},
		},
		required: true,
