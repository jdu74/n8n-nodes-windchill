...
export const PtcChangeMgmtChangeTaskActionUploadStage3ActionWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ChangeTasks('{ChangeTaskId}')/PTC.ChangeMgmt.UploadStage3Action",
				],
			},
		},
		required: true,
