...
export const ChangeableAffectedByChangeObjectsGetChangeItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Changeables('{ChangeableId}')/AffectedByChangeObjects('{ChangeItemId}')",
				],
			},
		},
		required: true,
