...
export const ChangeNoticeCnAffectLinksUpdateAffectedActivityDataLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /ChangeNotices('{ChangeNoticeId}')/CNAffectLinks('{AffectedActivityDataLinkItemId}')",
				],
			},
		},
		required: true,
