...
export const ChangeOrderCnAffectLinksGetAffectedActivityDataLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeOrders('{ChangeOrderId}')/CNAffectLinks('{AffectedActivityDataLinkItemId}')",
				],
			},
		},
		required: true,
