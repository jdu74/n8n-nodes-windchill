...
export const ChangeOrderResultingLinksGetResultingLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeOrders('{ChangeOrderId}')/ResultingLinks('{ResultingLinkItemId}')",
				],
			},
		},
		required: true,
