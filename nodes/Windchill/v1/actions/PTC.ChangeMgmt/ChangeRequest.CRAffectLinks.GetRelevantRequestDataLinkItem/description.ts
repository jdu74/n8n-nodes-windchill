...
export const ChangeRequestCrAffectLinksGetRelevantRequestDataLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeRequests('{ChangeRequestId}')/CRAffectLinks('{RelevantRequestDataLinkItemId}')",
				],
			},
		},
		required: true,
