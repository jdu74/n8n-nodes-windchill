...
export const PtcChangeMgmtProblemReportActionUploadStage1ActionWithDelegateNameDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ProblemReports('{ProblemReportId}')/PTC.ChangeMgmt.UploadStage1Action",
				],
			},
		},
		required: true,
		...
		options: [
			{
				...
				name: 'DelegateName',
				description: 'Delegate Name - string',
				type: 'string',
				default: '',
			},
			{
				displayName: '* NoOfFiles',
				name: 'NoOfFiles',
				description: 'No Of Files - integer',
				type: 'number',
				default: 0,
			},
		],
