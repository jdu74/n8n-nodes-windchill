...
export const VarianceCiAffectLinksUpdateReportedAgainstLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /Variances('{VarianceId}')/CIAffectLinks('{ReportedAgainstLinkItemId}')",
				],
			},
		},
		required: true,
