...
export const ActionSetStateChangeTasksDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			{
				displayName: '* ChangeTasks',
				name: 'ChangeTasks',
				description: 'Change Tasks - array',
				type: 'json',
				default: '[\n\t{\n\t\t"Latest": true,\n\t\t"LatestRevision": true,\n\t\t"Category": {\n\t\t\t"Value": "string",\n\t\t\t"Display": "string"\n\t\t},\n\t\t"ResolutionDate": "string",\n\t\t"ModifiedBy": "string",\n\t\t"Version": "string",\n\t\t"Identity": "string",\n\t\t"LastModified": "string",\n\t\t"CreatedBy": "string",\n\t\t"Revision": "string",\n\t\t"LifeCycleTemplateName": "string",\n\t\t"TeamTemplateName": "string",\n\t\t"NeedDate": "string",\n\t\t"ReservedBy": "string",\n\t\t"ObjectType": "string",\n\t\t"CreatedOn": "string",\n\t\t"ID": "string",\n\t\t"State": {\n\t\t\t"Value": "string",\n\t\t\t"Display": "string"\n\t\t},\n\t\t"Number": "string",\n\t\t"Sequence": "string",\n\t\t"IsRemote": true,\n\t\t"Description": "string",\n\t\t"Uri": "string",\n\t\t"TypeIcon": {\n\t\t\t"Path": "string",\n\t\t\t"Tooltip": "string"\n\t\t},\n\t\t"Name": "string",\n\t\t"DescriptionSummary": "string",\n\t\t"ChangeNoticeReference": {\n\t\t\t"Name": "string",\n\t\t\t"Identity": "string",\n\t\t\t"ResourceID": "string"\n\t\t},\n\t\t"VersionID": "string"\n\t}\n]',
			},
			{
				displayName: '* State',
				name: 'State',
