...
export const VarianceCiAffectLinksGetReportedAgainstLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Variances('{VarianceId}')/CIAffectLinks('{ReportedAgainstLinkItemId}')",
				],
			},
		},
		required: true,
