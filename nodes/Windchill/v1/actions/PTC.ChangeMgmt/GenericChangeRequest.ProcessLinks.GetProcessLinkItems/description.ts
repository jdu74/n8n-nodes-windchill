...
export const GenericChangeRequestProcessLinksGetProcessLinkItemsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/ProcessLinks",
				],
			},
		},
		required: true,
