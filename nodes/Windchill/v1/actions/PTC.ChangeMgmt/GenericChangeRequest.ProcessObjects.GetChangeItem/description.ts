...
export const GenericChangeRequestProcessObjectsGetChangeItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/ProcessObjects('{ChangeItemId}')",
				],
			},
		},
		required: true,
