...
export const PtcChangeMgmtChangeRequestActionUploadStage1ActionWithDelegateNameDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ChangeRequests('{ChangeRequestId}')/PTC.ChangeMgmt.UploadStage1Action",
				],
			},
		},
		required: true,
