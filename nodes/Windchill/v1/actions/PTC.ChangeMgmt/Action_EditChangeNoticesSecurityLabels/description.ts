...
export const ActionEditChangeNoticesSecurityLabelsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /EditChangeNoticesSecurityLabels',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* ChangeNotices',
				name: 'ChangeNotices',
				description: 'Change Notices - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
