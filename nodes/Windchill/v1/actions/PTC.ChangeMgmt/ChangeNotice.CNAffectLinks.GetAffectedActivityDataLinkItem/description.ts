...
export const ChangeNoticeCnAffectLinksGetAffectedActivityDataLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeNotices('{ChangeNoticeId}')/CNAffectLinks('{AffectedActivityDataLinkItemId}')",
				],
			},
		},
		required: true,
