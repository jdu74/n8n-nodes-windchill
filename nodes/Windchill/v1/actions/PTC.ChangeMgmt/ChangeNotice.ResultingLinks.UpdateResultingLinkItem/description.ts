...
export const ChangeNoticeResultingLinksUpdateResultingLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /ChangeNotices('{ChangeNoticeId}')/ResultingLinks('{ResultingLinkItemId}')",
				],
			},
		},
		required: true,
