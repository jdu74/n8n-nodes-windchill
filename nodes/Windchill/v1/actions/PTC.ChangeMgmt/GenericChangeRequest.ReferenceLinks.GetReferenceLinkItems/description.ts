...
export const GenericChangeRequestReferenceLinksGetReferenceLinkItemsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/ReferenceLinks",
				],
			},
		},
		required: true,
