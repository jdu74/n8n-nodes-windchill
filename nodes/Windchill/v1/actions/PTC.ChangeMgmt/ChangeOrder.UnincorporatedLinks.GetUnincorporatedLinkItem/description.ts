...
export const ChangeOrderUnincorporatedLinksGetUnincorporatedLinkItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /ChangeOrders('{ChangeOrderId}')/UnincorporatedLinks('{UnincorporatedLinkItemId}')",
				],
			},
		},
		required: true,
