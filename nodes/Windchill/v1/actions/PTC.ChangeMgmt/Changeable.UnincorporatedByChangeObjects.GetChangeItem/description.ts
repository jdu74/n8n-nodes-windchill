...
export const ChangeableUnincorporatedByChangeObjectsGetChangeItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Changeables('{ChangeableId}')/UnincorporatedByChangeObjects('{ChangeItemId}')",
				],
			},
		},
		required: true,
