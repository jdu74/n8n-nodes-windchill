...
export const GenericChangeRequestReferenceObjectsGetChangeItemsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /GenericChangeRequests('{GenericChangeRequestId}')/ReferenceObjects",
				],
			},
		},
		required: true,
