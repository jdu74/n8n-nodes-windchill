...
export const ActionSetStateGenericChangeRequestsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /SetStateGenericChangeRequests',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* GenericChangeRequests',
				name: 'GenericChangeRequests',
				description: 'Generic Change Requests - array',
				type: 'json',
