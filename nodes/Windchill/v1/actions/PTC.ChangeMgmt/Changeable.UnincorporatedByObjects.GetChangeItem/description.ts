...
export const ChangeableUnincorporatedByObjectsGetChangeItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Changeables('{ChangeableId}')/UnincorporatedByObjects('{ChangeItemId}')",
				],
			},
		},
		required: true,
