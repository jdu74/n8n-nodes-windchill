...
export const ChangeableUnincorporatedByChangeObjectsGetChangeItemsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Changeables('{ChangeableId}')/UnincorporatedByChangeObjects",
				],
			},
		},
		required: true,
