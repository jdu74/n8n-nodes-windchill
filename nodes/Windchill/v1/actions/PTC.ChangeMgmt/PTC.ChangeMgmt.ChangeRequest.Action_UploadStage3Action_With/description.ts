...
export const PtcChangeMgmtChangeRequestActionUploadStage3ActionWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /ChangeRequests('{ChangeRequestId}')/PTC.ChangeMgmt.UploadStage3Action",
				],
			},
		},
		required: true,
