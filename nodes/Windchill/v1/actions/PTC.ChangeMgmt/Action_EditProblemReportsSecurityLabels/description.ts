...
export const ActionEditProblemReportsSecurityLabelsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /EditProblemReportsSecurityLabels',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* ProblemReports',
				name: 'ProblemReports',
				description: 'Problem Reports - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
