...
export const CadDocumentPartDocAssociationsGetPartDocAssociationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /CADDocuments('{CADDocumentId}')/PartDocAssociations('{PartDocAssociationId}')",
				],
			},
		},
		required: true,
