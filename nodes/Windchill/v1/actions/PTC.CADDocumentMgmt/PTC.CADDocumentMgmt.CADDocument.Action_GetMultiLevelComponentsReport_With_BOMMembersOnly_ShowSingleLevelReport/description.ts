...
export const PtcCadDocumentMgmtCadDocumentActionGetMultiLevelComponentsReportWithBomMembersOnlyShowSingleLevelReportDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /CADDocuments('{CADDocumentId}')/PTC.CADDocumentMgmt.GetMultiLevelComponentsReport",
				],
			},
		},
		required: true,
	...
	},
	{
		...
		options: [
			...
			{
				displayName: 'ShowSingleLevelReport',
				name: 'ShowSingleLevelReport',
				description: 'Whether Show Single Level Report - boolean',
				type: 'boolean',
				default: false,
			},
		],
