...
export const ActionEditDynamicDocumentsSecurityLabelsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /EditDynamicDocumentsSecurityLabels',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* DynamicDocuments',
				name: 'DynamicDocuments',
				description: 'Dynamic Documents - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
