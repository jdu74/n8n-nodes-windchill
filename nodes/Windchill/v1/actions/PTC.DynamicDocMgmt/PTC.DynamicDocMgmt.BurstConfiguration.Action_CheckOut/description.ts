...
export const PtcDynamicDocMgmtBurstConfigurationActionCheckOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /BurstConfigurations('{BurstConfigurationId}')/PTC.DynamicDocMgmt.CheckOut",
				],
			},
		},
		required: true,
