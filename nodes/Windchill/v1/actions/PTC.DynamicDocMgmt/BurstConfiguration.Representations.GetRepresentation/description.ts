...
export const BurstConfigurationRepresentationsGetRepresentationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/Representations('{RepresentationId}')",
				],
			},
		},
		required: true,
