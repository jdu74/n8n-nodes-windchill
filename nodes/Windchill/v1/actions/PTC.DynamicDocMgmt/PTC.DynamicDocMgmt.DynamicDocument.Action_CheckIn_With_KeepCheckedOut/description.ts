...
export const PtcDynamicDocMgmtDynamicDocumentActionCheckInWithKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DynamicDocuments('{DynamicDocumentId}')/PTC.DynamicDocMgmt.CheckIn",
				],
			},
		},
		required: true,
