...
export const BurstConfigurationReferencedByGetDynamicDocumentDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/ReferencedBy('{DynamicDocumentId}')",
				],
			},
		},
		required: true,
