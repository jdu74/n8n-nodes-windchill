...
export const ActionSetStateBurstConfigurationsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /SetStateBurstConfigurations',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* BurstConfigurations',
				name: 'BurstConfigurations',
				description: 'Burst Configurations - array',
				type: 'json',
