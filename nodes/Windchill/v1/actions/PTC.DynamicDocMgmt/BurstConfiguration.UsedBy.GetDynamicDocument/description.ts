...
export const BurstConfigurationUsedByGetDynamicDocumentDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/UsedBy('{DynamicDocumentId}')",
				],
			},
		},
		required: true,
