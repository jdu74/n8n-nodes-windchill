...
export const BurstConfigurationVersionsGetDynamicDocumentDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/Versions('{DynamicDocumentId}')",
				],
			},
		},
		required: true,
