...
export const DynamicDocumentReferenceLinksGetDynamicDocumentReferenceDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /DynamicDocuments('{DynamicDocumentId}')/ReferenceLinks('{DynamicDocumentReferenceId}')",
				],
			},
		},
		required: true,
