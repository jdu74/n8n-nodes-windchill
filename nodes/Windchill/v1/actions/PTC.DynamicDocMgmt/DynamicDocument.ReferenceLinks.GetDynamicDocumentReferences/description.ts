...
export const DynamicDocumentReferenceLinksGetDynamicDocumentReferencesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /DynamicDocuments('{DynamicDocumentId}')/ReferenceLinks",
				],
			},
		},
		required: true,
