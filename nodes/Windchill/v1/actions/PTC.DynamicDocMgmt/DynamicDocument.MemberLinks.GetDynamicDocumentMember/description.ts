...
export const DynamicDocumentMemberLinksGetDynamicDocumentMemberDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /DynamicDocuments('{DynamicDocumentId}')/MemberLinks('{DynamicDocumentMemberId}')",
				],
			},
		},
		required: true,
