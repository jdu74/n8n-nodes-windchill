...
export const BurstConfigurationAttachmentsGetContentItemDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/Attachments('{ContentItemId}')",
				],
			},
		},
		required: true,
