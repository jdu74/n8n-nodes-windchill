...
export const BurstConfigurationMemberLinksGetDynamicDocumentMemberDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/MemberLinks('{DynamicDocumentMemberId}')",
				],
			},
		},
		required: true,
