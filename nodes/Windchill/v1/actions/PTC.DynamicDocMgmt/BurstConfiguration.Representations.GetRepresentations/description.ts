...
export const BurstConfigurationRepresentationsGetRepresentationsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/Representations",
				],
			},
		},
		required: true,
