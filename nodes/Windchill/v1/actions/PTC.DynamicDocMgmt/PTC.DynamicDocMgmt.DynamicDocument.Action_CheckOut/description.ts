...
export const PtcDynamicDocMgmtDynamicDocumentActionCheckOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DynamicDocuments('{DynamicDocumentId}')/PTC.DynamicDocMgmt.CheckOut",
				],
			},
		},
		required: true,
