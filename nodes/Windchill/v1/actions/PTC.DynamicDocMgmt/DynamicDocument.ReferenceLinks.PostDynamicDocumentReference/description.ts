...
export const DynamicDocumentReferenceLinksPostDynamicDocumentReferenceDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DynamicDocuments('{DynamicDocumentId}')/ReferenceLinks",
				],
			},
		},
		required: true,
