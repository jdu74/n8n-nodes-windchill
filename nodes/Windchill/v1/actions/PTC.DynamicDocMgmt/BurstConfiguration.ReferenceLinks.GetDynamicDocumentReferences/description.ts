...
export const BurstConfigurationReferenceLinksGetDynamicDocumentReferencesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/ReferenceLinks",
				],
			},
		},
		required: true,
