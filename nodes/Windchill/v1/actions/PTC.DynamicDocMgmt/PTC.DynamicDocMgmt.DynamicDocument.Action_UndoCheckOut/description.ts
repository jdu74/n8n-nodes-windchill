...
export const PtcDynamicDocMgmtDynamicDocumentActionUndoCheckOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /DynamicDocuments('{DynamicDocumentId}')/PTC.DynamicDocMgmt.UndoCheckOut",
				],
			},
		},
		required: true,
