...
export const DynamicDocumentReferenceLinksUpdateDynamicDocumentReferenceDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /DynamicDocuments('{DynamicDocumentId}')/ReferenceLinks('{DynamicDocumentReferenceId}')",
				],
			},
		},
		required: true,
