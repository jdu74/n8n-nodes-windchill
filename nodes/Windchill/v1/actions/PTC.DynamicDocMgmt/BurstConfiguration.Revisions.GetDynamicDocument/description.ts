...
export const BurstConfigurationRevisionsGetDynamicDocumentDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/Revisions('{DynamicDocumentId}')",
				],
			},
		},
		required: true,
