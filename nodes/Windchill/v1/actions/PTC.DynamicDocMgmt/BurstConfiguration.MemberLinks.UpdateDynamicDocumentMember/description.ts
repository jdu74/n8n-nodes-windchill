...
export const BurstConfigurationMemberLinksUpdateDynamicDocumentMemberDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /BurstConfigurations('{BurstConfigurationId}')/MemberLinks('{DynamicDocumentMemberId}')",
				],
			},
		},
		required: true,
