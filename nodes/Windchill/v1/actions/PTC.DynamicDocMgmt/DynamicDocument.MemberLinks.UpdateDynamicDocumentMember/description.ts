...
export const DynamicDocumentMemberLinksUpdateDynamicDocumentMemberDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /DynamicDocuments('{DynamicDocumentId}')/MemberLinks('{DynamicDocumentMemberId}')",
				],
			},
		},
		required: true,
