...
export const PtcDynamicDocMgmtBurstConfigurationActionUndoCheckOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /BurstConfigurations('{BurstConfigurationId}')/PTC.DynamicDocMgmt.UndoCheckOut",
				],
			},
		},
		required: true,
