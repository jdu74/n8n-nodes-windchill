...
export const BurstConfigurationReferenceLinksUpdateDynamicDocumentReferenceDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /BurstConfigurations('{BurstConfigurationId}')/ReferenceLinks('{DynamicDocumentReferenceId}')",
				],
			},
		},
		required: true,
