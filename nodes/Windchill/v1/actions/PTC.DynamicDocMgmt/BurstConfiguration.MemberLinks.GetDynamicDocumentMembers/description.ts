...
export const BurstConfigurationMemberLinksGetDynamicDocumentMembersDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/MemberLinks",
				],
			},
		},
		required: true,
