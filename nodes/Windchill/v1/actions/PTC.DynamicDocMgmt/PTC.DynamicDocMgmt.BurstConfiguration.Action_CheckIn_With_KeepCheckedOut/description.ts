...
export const PtcDynamicDocMgmtBurstConfigurationActionCheckInWithKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /BurstConfigurations('{BurstConfigurationId}')/PTC.DynamicDocMgmt.CheckIn",
				],
			},
		},
		required: true,
