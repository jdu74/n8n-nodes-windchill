...
export const BurstConfigurationTranslationsGetDynamicDocumentDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /BurstConfigurations('{BurstConfigurationId}')/Translations('{DynamicDocumentId}')",
				],
			},
		},
		required: true,
