...
export const BurstConfigurationReferenceLinksPostDynamicDocumentReferenceDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /BurstConfigurations('{BurstConfigurationId}')/ReferenceLinks",
				],
			},
		},
		required: true,
