...
export const StandardControlCharacteristicSccResourceLinksGetSccResourceUsagesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/SCCResourceLinks",
				],
			},
		},
		required: true,
