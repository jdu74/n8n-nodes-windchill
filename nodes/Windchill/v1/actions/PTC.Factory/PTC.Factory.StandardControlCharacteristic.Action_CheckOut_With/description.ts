...
export const PtcFactoryStandardControlCharacteristicActionCheckOutWithDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardControlCharacteristics('{StandardControlCharacteristicId}')/PTC.Factory.CheckOut",
				],
			},
		},
		required: true,
