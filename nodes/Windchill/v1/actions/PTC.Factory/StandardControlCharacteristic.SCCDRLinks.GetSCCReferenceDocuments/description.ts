...
export const StandardControlCharacteristicSccdrLinksGetSccReferenceDocumentsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/SCCDRLinks",
				],
			},
		},
		required: true,
