...
export const StandardOperationRevisionsGetStandardOperationDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardOperations('{StandardOperationId}')/Revisions('{RevisionsId}')",
				],
			},
		},
		required: true,
