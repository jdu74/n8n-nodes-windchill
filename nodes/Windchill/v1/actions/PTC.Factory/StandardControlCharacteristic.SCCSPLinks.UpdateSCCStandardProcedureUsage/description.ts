...
export const StandardControlCharacteristicSccspLinksUpdateSccStandardProcedureUsageDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"PATCH /StandardControlCharacteristics('{StandardControlCharacteristicId}')/SCCSPLinks('{SCCStandardProcedureUsageId}')",
				],
			},
		},
		required: true,
