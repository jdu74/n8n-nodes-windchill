...
export const StandardControlCharacteristicVersionsGetStandardControlCharacteristicDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/Versions('{VersionsId}')",
				],
			},
		},
		required: true,
