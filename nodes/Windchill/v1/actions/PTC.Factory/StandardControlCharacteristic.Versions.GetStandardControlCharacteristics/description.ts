...
export const StandardControlCharacteristicVersionsGetStandardControlCharacteristicsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/Versions",
				],
			},
		},
		required: true,
