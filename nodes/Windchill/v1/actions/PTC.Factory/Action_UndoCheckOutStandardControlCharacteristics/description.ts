...
export const ActionUndoCheckOutStandardControlCharacteristicsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /UndoCheckOutStandardControlCharacteristics',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* Workables',
				name: 'Workables',
				description: 'Workables - array',
				type: 'json',
				default: '[\n\t{\n\t\t"ID": "string"\n\t}\n]',
			},
		],
