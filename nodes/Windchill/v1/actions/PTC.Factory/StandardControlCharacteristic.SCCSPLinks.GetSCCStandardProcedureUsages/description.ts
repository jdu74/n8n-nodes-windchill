...
export const StandardControlCharacteristicSccspLinksGetSccStandardProcedureUsagesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/SCCSPLinks",
				],
			},
		},
		required: true,
