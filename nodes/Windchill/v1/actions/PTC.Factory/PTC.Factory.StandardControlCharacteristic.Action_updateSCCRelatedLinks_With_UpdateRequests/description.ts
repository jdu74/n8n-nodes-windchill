...
export const PtcFactoryStandardControlCharacteristicActionUpdateSccRelatedLinksWithUpdateRequestsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardControlCharacteristics('{StandardControlCharacteristicId}')/PTC.Factory.updateSCCRelatedLinks",
				],
			},
		},
		required: true,
