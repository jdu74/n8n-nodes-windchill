...
export const PtcFactoryStandardProcedureActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardProcedures('{StandardProcedureId}')/PTC.Factory.CheckIn",
				],
			},
		},
		required: true,
