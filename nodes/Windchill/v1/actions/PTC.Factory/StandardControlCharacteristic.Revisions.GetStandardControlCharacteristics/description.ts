...
export const StandardControlCharacteristicRevisionsGetStandardControlCharacteristicsDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/Revisions",
				],
			},
		},
		required: true,
