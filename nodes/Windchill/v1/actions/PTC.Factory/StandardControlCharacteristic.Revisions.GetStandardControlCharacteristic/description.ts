...
export const StandardControlCharacteristicRevisionsGetStandardControlCharacteristicDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/Revisions('{RevisionsId}')",
				],
			},
		},
		required: true,
