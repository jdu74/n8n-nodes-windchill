...
export const StandardProcedureRevisionsGetStandardProcedureDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardProcedures('{StandardProcedureId}')/Revisions('{RevisionsId}')",
				],
			},
		},
		required: true,
