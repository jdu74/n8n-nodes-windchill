...
export const PtcFactoryStandardOperationActionCheckInWithCheckOutNoteKeepCheckedOutDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /StandardOperations('{StandardOperationId}')/PTC.Factory.CheckIn",
				],
			},
		},
		required: true,
