...
export const StandardControlCharacteristicSccdrLinksGetSccReferenceDocumentDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/SCCDRLinks('{SCCReferenceDocumentId}')",
				],
			},
		},
		required: true,
