...
export const ActionSetStateStandardProceduresDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					'POST /SetStateStandardProcedures',
				],
			},
		},
	},
	...
	},
	{
		...
		options: [
			{
				displayName: '* StandardProcedures',
				name: 'StandardProcedures',
				description: 'Standard Procedures - array',
				type: 'json',
