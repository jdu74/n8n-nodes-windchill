...
export const StandardControlCharacteristicSccResourceLinksGetSccResourceUsageDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /StandardControlCharacteristics('{StandardControlCharacteristicId}')/SCCResourceLinks('{SCCResourceUsageId}')",
				],
			},
		},
		required: true,
