...
export const PtcDocMgmtDocumentActionUploadStage1ActionWithDelegateNameDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"POST /Documents('{DocumentId}')/PTC.DocMgmt.UploadStage1Action",
				],
			},
		},
		required: true,
