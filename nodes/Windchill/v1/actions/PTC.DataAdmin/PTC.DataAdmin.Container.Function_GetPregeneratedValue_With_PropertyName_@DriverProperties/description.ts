...
export const PtcDataAdminContainerFunctionGetPregeneratedValueWithPropertyNameDriverPropertiesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Containers('{ContainerId}')/PTC.DataAdmin.GetPregeneratedValue(EntityName='{EntityName}',PropertyName='{PropertyName}',DriverProperties=@DriverProperties)",
				],
			},
		},
		required: true,
