...
export const PtcDataAdminContainerFunctionGetConstraintsWithEntityVersionPropertyNameDriverPropertiesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Containers('{ContainerId}')/PTC.DataAdmin.GetConstraints(EntityName='{EntityName}',EntityVersion='{EntityVersion}',PropertyName='{PropertyName}',DriverProperties=@DriverProperties)",
				],
			},
		},
		required: true,
