...
export const PtcDataAdminContainerFunctionGetConstraintsWithEntityVersionDriverPropertiesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Containers('{ContainerId}')/PTC.DataAdmin.GetConstraints(EntityName='{EntityName}',EntityVersion='{EntityVersion}',DriverProperties=@DriverProperties)",
				],
			},
		},
		required: true,
