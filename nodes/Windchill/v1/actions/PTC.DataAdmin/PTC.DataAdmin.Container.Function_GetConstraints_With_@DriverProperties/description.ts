...
export const PtcDataAdminContainerFunctionGetConstraintsWithDriverPropertiesDescription: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: [
					"GET /Containers('{ContainerId}')/PTC.DataAdmin.GetConstraints(EntityName='{EntityName}',DriverProperties=@DriverProperties)",
				],
			},
		},
		required: true,
